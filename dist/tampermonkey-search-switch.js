...
(function() {
    window.WeltTool = function(config) {
        ...
        if (titleDiv.innerHTML = "#xyzs-welt-tool{position:fixed;display:flex;background-color:#000;opacity:.3;border-radius:0 40px 40px 0;color:#fff;padding:10px 35px 10px 5px;flex-direction:column;bottom:100px;left:0;z-index:99999;transition:all .4s;box-shadow:2px 2px 4px 0 #c1c1c1}#xyzs-welt-tool:hover{opacity:1;border-radius:0 10px 10px 0}.xyzs-title-div{font-size:5px;margin:0 5px 5px 5px}.xyzs-item-list-div{margin:0;display:flex;justify-content:center}.xyzs-item-div{display:flex;margin:0 5px;color:#0cc;font-size:14px;cursor:pointer}.icon{width:1em;height:1em;vertical-align:-.15em;fill:currentColor;overflow:hidden}", bodyDom.appendChild(titleDiv), (mainDivDom = document.createElement("div")).id = config.id, 
